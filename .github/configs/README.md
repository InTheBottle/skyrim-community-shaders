...
3. Bottled Shaders to be run once with specific settings to generate the required log data

### Prerequisites

Before running the generation script, you must run Skyrim SE **once** with the following Bottled Shaders settings:

1. **Set Debug Log Level**: In the Bottled Shaders menu, set the log level to "Debug" or "Trace"
